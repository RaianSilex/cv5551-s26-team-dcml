...
from config import ROBOT_IP, INGREDIENT_TAG_MAP, STIRRER_TAG_ID, STIRRER_POSE_KEY, MAIN_CUP_POSITION
...
def main():
    ...
    try:
        ...
        print(f'  {"stirrer":>10} (tag {STIRRER_TAG_ID}): {"FOUND" if STIRRER_POSE_KEY in poses else "MISSING"}')
